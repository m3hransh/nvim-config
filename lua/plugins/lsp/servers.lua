...
function M.setup(_, opts)
  ...
  local function setup(server)
    ...
    --   if opts.servers[server](server, server_opts) then
    --     return
    --   end
    -- elseif opts.servers["*"] then
    --   if opts.servers["*"](server, server_opts) then
    --     return
    --   end
    -- end
